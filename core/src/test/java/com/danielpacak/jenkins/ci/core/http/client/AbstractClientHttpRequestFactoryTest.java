...
public abstract class AbstractClientHttpRequestFactoryTest {
   ...
   public void echo() throws Exception {
      ...
      Streams.copy(body, request.getBody());
      ...
      try {
         ...
         byte[] result = Streams.toByteArray(response.getBody());
   ...
   private static class EchoServlet extends HttpServlet {
      ...
      private void echo(HttpServletRequest request, HttpServletResponse response) throws IOException {
         ...
         Streams.copy(request.getInputStream(), response.getOutputStream());
      }
   }
